...
public class NewtonMethod extends Method {
	...
	@Override
	public Solution solve(Function f, Map<String, Object> arguments)
	...
	@Override
	public void init(Function f, Map<String, Object> arguments)
			throws ArgumentsException {
		super.initSuperMethod(f, arguments);
		if (!arguments.containsKey(START_POINT))
			throw new ArgumentsException(String.format(
					"%s Argument of Type Double is missing", start_point));

		if (!arguments.containsKey(MAX_ITERATIONS))
			throw new ArgumentsException(String.format(
					"%s Argument of Type Integer is missing", MAX_ITERATIONS));
